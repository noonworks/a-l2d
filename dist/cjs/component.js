 ...
 * @ignore
 */
exports.COMPONENT_NAME = 'l2d';
/**
 * @ignore
 * Component object to register to A-Frame.
 */
exports.L2D_COMPONENT = {
    _marker: null,
    _mesh: null,
    _models: [],
    ...
    _updateAsset: function (oldData) {
        ...
        new asset_1.AssetLoader()
            ...
            _this._models = assets.map(function (asset) { return new model_1.Model(asset); });
            _this._initPixiApp();
            if (!_this._pixiapp) {
            ...
            try {
                model_1.appendModels(_this._models, _this._pixiapp);
